<table>
    ...
    <tr class="item-row <%= torrent.isTorrentCollection ? 'collection-source' : 'fallback-source' %>" data-key="<%=k %>">
        ...
        <td class="source-kind item-play<%= Settings.seriesUITransparency ? '' : ' transpOff' %>"><span class="source-badge"><%= torrent.isTorrentCollection ? i18n.__('Torrent Collection') : i18n.__('Fallback API') %></span></td>
