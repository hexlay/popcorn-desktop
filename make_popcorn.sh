...
## ./make_popcorn.sh '-b development https://github.com/hexlay/popcorn-desktop'
##


clone_repo="True"
if [ -z "$1" ]; then
    clone_url="https://github.com/hexlay/popcorn-desktop.git"
elif [ "$1" = "ssh" ]; then
    clone_url="ssh://git@github.com:hexlay/popcorn-desktop.git"
else
    clone_url="$1"
fi
